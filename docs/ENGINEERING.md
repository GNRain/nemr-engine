# Nemr — engineering notes

> This is the detailed build record: how each part was implemented, what was
> measured, and why each decision went the way it did. It is written for
> someone working on the engine.
>
> **If you are trying to understand or use Nemr, start with [the README](../README.md).**
